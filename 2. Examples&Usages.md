...
#### _ gmaps.heatmap_layer(locations, weights=None, max_intensity=None, dissipating=True, point_radius=None, opacity=0.6, gradient=None)
...
#### _ gmaps.symbol_layer(locations, hover_text=’‘, fill_color=None, fill_opacity=1.0, stroke_color=None, stroke_opacity=1.0, scale=3, info_box_content=None, display_info_box=None)
...
#### _ gmaps.directions_layer(start, end, waypoints=None)
...
#### _ gmaps.marker_layer(locations, hover_text=’‘, label=’‘, info_box_content=None, display_info_box=None)
